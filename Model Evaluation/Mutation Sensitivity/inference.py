...
models = [  # Commented out ones are done.
    ...
    # ["Hyena", ["LongSafari/hyenadna-medium-160k-seqlen-hf", "LongSafari/hyenadna-medium-450k-seqlen-hf", "LongSafari/hyenadna-large-1m-seqlen-hf",]]
]
...
def main(seqType, seqClass):
    ...
    for model in models:
        ...
        for fraction in fractions:
            ...
            print(
                f"Done with {fraction}% of Maxlen sequences for {modelFolder} in {round(end - start, 2)}"
            )
